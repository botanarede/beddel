...
from beddel_bonar_cms.tools.deploy import deploy_site, provision_firebase
...
class TestDeploySiteSuccess:
    ...
    def test_successful_deploy_returns_success_dict(self, tmp_path) -> None:
        ...
        with (
            patch(
                "beddel_bonar_cms.tools.deploy.SafeSubprocessRunner.run",
                return_value=_success_result(
                    stdout="Deploying...\nHosting URL: https://my-proj.web.app\nDone"
                ),
            ),
            patch(
                "beddel_bonar_cms.tools.deploy.get_kit_root",
...
class TestErrorCodes:
    ...
    def test_cms_deploy_failed_resolves(self) -> None:
        ...
        from beddel_bonar_cms._errors import CMS_DEPLOY_FAILED as imported
    ...
    def test_cms_provision_failed_resolves(self) -> None:
        ...
        from beddel_bonar_cms._errors import CMS_PROVISION_FAILED as imported
