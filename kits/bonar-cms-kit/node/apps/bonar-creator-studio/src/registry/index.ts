...
import { ContactTabsCasasavana } from '@/components/sections/ContactTabsCasasavana'
import { PhotoGalleryCasasavana } from '@/components/sections/PhotoGalleryCasasavana'

// Legacy brasilprana components (still needed until brasilprana migrates)
...
const COMPONENT_MAP: Record<string, SectionComponent> = {
  ...
  ContactTabsCasasavana,
  PhotoGalleryCasasavana,
  SiteFooter,
  // Legacy brasilprana components
  AboutSection,
  ServicesSection,
  CTASection,
  FooterSection,
