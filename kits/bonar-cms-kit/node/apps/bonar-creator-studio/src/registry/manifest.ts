...
/**
 * Component manifest for bonar-creator-studio.
...
export const appManifest = createManifest([
  ...
  { type: 'ContactTabsCasasavana', displayName: 'Contact Tabs (Casa Savana)', category: 'section' },
  { type: 'PhotoGallery', displayName: 'Photo Gallery', category: 'section' },
  { type: 'PhotoGalleryCasasavana', displayName: 'Photo Gallery (Casa Savana)', category: 'section' },
