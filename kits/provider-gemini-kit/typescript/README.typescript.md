# provider-gemini-kit — TypeScript target (planned)

**Status:** planned
**Planned entry point:** `./typescript/src/provider.ts`
...
See peer kit provider-gemini-adk-kit for prior art using @google/adk. TS implementation may use @google/genai for symmetry with the Python google-generativeai package.
