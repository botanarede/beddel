...
is absent, so callers can degrade gracefully to 503.

[Source: packages/beddel-py/src/beddel/serve/agent_engine/adapter.py]
[Source: vendor/beddel/kits/serve-fastapi-kit/python/beddel_serve_fastapi/agent_engine_routes.py]
"""
...
class VertexAgentEngineAdapter:
    ...
    async def list_agents(self) -> list[AgentInfo]:
        ...
        Returns:
            List of :class:`~beddel.serve.agent_engine.models.AgentInfo`, one per deployed agent.
        """
    ...
    async def chat(
        ...
        *,
        ...
        Yields:
            :class:`~beddel.serve.agent_engine.models.ChatChunk` instances.
        """
        loop = asyncio.get_event_loop()
