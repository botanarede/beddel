"""Unit tests for beddel_solution_cms.tenant_context."""
...
from beddel_solution_cms._errors import CMS_INVALID_TENANT_ID, CMS_TENANT_NOT_FOUND


def test_get_kit_root_resolves_to_kit_directory() -> None:
    root = tenant_context.get_kit_root()
    assert root.name == "solution-cms-kit"
