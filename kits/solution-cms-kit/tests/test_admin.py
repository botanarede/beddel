...
from beddel_solution_cms._errors import CMS_ADMIN_ERROR, CMSError
from beddel_solution_cms.tools.admin import (
    create_user,
    get_tenant_stats,
    list_users,
    update_user_role,
...
def _patch_kit_root(kit_root: Path) -> None:  # noqa: PT004
    ...
    with patch("beddel_solution_cms.tools.admin.get_kit_root", return_value=kit_root):
        yield
