...
from beddel_solution_cms._errors import CMS_INVALID_TENANT_ID, CMS_PREVIEW_FAILED, CMSError
from beddel_solution_cms.tools.preview import preview_site, stop_preview
...
class TestPreviewSite:
    ...
    @patch("beddel_solution_cms.tools.preview.subprocess.Popen")
...
class TestStopPreview:
    ...
    @patch("beddel_solution_cms.tools.preview.os.kill")
